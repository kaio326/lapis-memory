...
local probe     = require("lapis_memory.cli.probe")
local recommend = require("lapis_memory.cli.recommend")
...
local function fmt_snippet(rec)
    local lines = { "require(\"lapis_memory\").setup({" }
    local order = {
